...
import { ShipyardPageComponent } from './shipyard-page.component';
...
describe('ShipyardPageComponent', () => {
  ...
  it('shows a hint when there are no planets', async () => {
    await setup([], null);
    const fixture = TestBed.createComponent(ShipyardPageComponent);
    fixture.detectChanges();

    expect(fixture.nativeElement.querySelector('select')).toBeNull();
  });

  it('renders the planet select and shipyard when planets exist', async () => {
    await setup([planet(1)], 1);
    const fixture = TestBed.createComponent(ShipyardPageComponent);
    fixture.detectChanges();

    expect(fixture.nativeElement.querySelector('select')).not.toBeNull();
    expect(fixture.nativeElement.querySelector('app-shipyard')).not.toBeNull();
  });
